...
def create_vne(min_nodes=2, max_nodes=5, no_requests=300, probability=0.4):
    ...
    for i in range(len(new_vne_req)):
        ...
        vne.append(graph_u.Graph(nodes, edges, Parameters(1, 10, 1, 10, 0, 100, 0, 100, 1, 4)) )  # for vne request BW ,CRB, Location,Delay
    #print (vne)
    return vne
