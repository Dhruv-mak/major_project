...
def create_vne(min_nodes=2, max_nodes=10, no_requests=125, probability=0.4, mean=0.4):
    ...
    for i in range(len(new_vne_req)):
        ...
        vne.append(graph_p.Graph(nodes, edges, Parameters(10, 50, 10, 50, 0, 100, 0, 100, 1, 4), mean) )  # for vne request BW ,CRB, Location,Delay
    #print (vne)
    return vne
