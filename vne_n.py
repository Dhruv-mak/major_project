...
def create_vne(min_nodes=2, max_nodes=10, no_requests=5, probability=0.4):
    ...
    for i in range(len(new_vne_req)):
        ...
        vne.append(graph_n.Graph(nodes, edges, Parameters(10, 50, 10, 50, 0, 100, 0, 100, 1, 4)) )  # for vne request
    return vne
