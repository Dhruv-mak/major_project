...
def create_vne(min_nodes=2, max_nodes=5, no_requests=10, probability=0.4):
    random_node_list = [
    ...
    for i in range(len(new_vne_req)):
        ...
        vne.append(graph.Graph(nodes, edges, Parameters(10, 25, 10, 25, 0, 40, 0, 40, 3, 8)) )  # for vne request
    return vne
