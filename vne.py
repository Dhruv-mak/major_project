...
def create_vne(min_nodes=2, max_nodes=5, no_requests=20, probability=0.4):
    random_node_list = [
    ...
    for i in range(len(new_vne_req)):
        ...
        vne.append(graph.Graph(nodes, edges, Parameters(1, 20, 1, 20, 0, 100, 0, 100, 1, 4)) )  # for vne request
    return vne
